...
export const WriterInputSchema = Type.Object({
    ...
    lorebookEntries: Type.Optional(Type.Array(Type.Object({
        path: Type.String({description: "内容节点路径，例如 lorebook/character/foo/。目录会读取 index.md，并读取同级可选 state.md。"}),
    ...
    outputPath: Type.Optional(Type.String({description: "可选输出文件路径。给出时 writer 应把正文写入该文件并润色。"})),
