...
function printUsage(): void {
    console.error("用法：variable definition <status|check|compile> [--global [--workspace-root <workspaceRoot>] | --project <projectWorkspace>]");
    console.error("示例：variable definition compile --global --workspace-root workspace");
    console.error("示例：variable definition status --project novels/demo");
}
