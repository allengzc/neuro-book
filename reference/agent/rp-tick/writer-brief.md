...
- 这条路径会直接交给 Agent 文件工具。Agent cwd 是 Workspace Root，因此必须使用 Workspace Root cwd-relative Project 路径，形如 `{project-slug}/simulation/runs/ticks/{id}-{slug}/prose.md`。
...
prose 输出路径：project-slug/simulation/runs/ticks/000000-initial-state/prose.md
```
...
prose 输出路径：project-slug/simulation/runs/ticks/000003-approach-glasses-girl/prose.md
```
