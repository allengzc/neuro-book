...
var PROJECT_DATABASE_RELATIVE_PATH, PROJECT_MIGRATION_SQL;
...
async function executeSql(context, sql) {
  ...
  return executeSqliteSql(requireProjectPath(context.workspaceRoot), normalized);
}
...
async function defaultSqlSchemaSummaryText(ctx) {
  try {
    ...
    return [
      ...
      await getAgentSqlSchemaSummary2(ctx.session.workspaceRoot),
      "</sql-schema-summary>"
    ].join("\n");
  } catch (error) {
    const message = error instanceof Error ? error.message : String(error);
  ...
  context() {
    return /* @__PURE__ */ jsxs(ProfilePrompt, { children: [
      ...
      /* @__PURE__ */ jsxs(ModelContext, { children: [
        ...
        /* @__PURE__ */ jsx(VariableSchema, { namespace: "client", includeToolGuide: true })
      ] }),
      /* @__PURE__ */ jsxs(AppendingSet, { children: [
        /* @__PURE__ */ jsx(ProjectReminder, {}),
