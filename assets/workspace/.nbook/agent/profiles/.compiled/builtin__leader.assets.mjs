  ...
  context(ctx) {
    return /* @__PURE__ */ jsxs(ProfilePrompt, { children: [
      ...
      /* @__PURE__ */ jsxs(AppendingSet, { children: [
        /* @__PURE__ */ jsx(RuntimeLocationReminder, { mode: "userAssets", repeatEveryTurns: 20 }),
        /* @__PURE__ */ jsx(Reminder, { id: "user-assets-scope", watch: () => readInputRole(ctx), repeatEveryTurns: 20, children: /* @__PURE__ */ jsx(Message, { children: [
          "<system-reminder>",
