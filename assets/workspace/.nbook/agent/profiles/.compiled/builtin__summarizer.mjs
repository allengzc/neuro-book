...
function assertProfileSidecars(profileKey, allowedToolKeys, sidecars) {
  if (!sidecars) {
    return;
  }
  const seen = /* @__PURE__ */ new Set();
...
// assets/workspace/.nbook/agent/profiles/builtin/summarizer.profile.tsx
var profileManifest = {
  key: "summarizer",
...
var summarizer_profile_default = defineAgentProfile({
  ...
  async context(ctx) {
    ...
    return /* @__PURE__ */ jsxs(ProfilePrompt, { children: [
      ...
      /* @__PURE__ */ jsx(ModelContext, { children: /* @__PURE__ */ jsx(Message, { children: dialogue.text || "\u5F53\u524D source session \u6CA1\u6709\u53EF\u6458\u8981\u7684 Agent Dialogue Content\u3002" }) })
    ] });
  }
});
...
async function readSourceState(sourceSessionId, ctx) {
...
function jsonState(state) {
  return Object.fromEntries(Object.entries(state).filter(([, value]) => value !== void 0));
}
export {
  InputSchema,
  OutputSchema,
