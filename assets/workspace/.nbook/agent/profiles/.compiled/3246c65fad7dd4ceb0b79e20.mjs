...
var init_client = __esm({
  "server/generated/prisma/client.ts"() {
    ...
    init_enums();
    init_enums();
    globalThis["__dirname"] = path5.dirname(fileURLToPath3(import.meta.url));
...
var SYSTEM_WRITING_PRESETS_ROOT = path.join(SYSTEM_NBOOK_ROOT, "agent", "writing-presets");
var USER_WRITING_PRESETS_ROOT = path.resolve(process.cwd(), USER_NBOOK_ROOT, "agent", "writing-presets");
...
var WRITING_REFERENCE_DIR_CANDIDATES = [
  path3.join(assetResolver.systemRoot, "agent", "writing-presets", "references"),
  path3.join(assetResolver.userRoot, "agent", "writing-presets", "references")
];
...
var WRITING_STYLE_DIR_CANDIDATES = [
  path4.join(assetResolver.systemRoot, "agent", "writing-presets", "styles"),
  path4.join(assetResolver.userRoot, "agent", "writing-presets", "styles")
];
...
async function loadPrisma() {
  return (await Promise.resolve().then(() => (init_prisma(), prisma_exports))).prisma;
}
export {
  InputSchema,
  OutputSchema,
